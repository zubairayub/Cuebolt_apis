...
if (!function_exists('send_push_notification')) {
    function send_push_notification(array $tokens, $title, $body, $data = [], $type,  $userIds)
    {
        app(App\Providers\FirebaseServiceProvider::class)->sendNotification($tokens, $title, $body, $data, $type, $userIds);
